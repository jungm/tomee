...
If set to true, request virtual-thread-backed execution. On runtimes that do not support virtual threads this fails resource creation.
...
If set to true, request virtual threads. On runtimes that do not support virtual threads this fails resource creation.
